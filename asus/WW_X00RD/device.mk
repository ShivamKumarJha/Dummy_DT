...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_mtp_NOPA.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_NOPA.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_mtp_PA.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_PA.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_mtp_eu.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_eu.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_mtp_noeu.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_noeu.xml \
...
# Inherit vendor
$(call inherit-product, vendor/asus/WW_X00RD/WW_X00RD-vendor.mk)