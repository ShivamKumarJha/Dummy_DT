...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_codec_status.sh:$(TARGET_COPY_OUT_VENDOR)/etc/audio_codec_status.sh \
    $(LOCAL_PATH)/configs/audio/audio_effects.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.conf \
    $(LOCAL_PATH)/configs/audio/audio_effects.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.xml \
    $(LOCAL_PATH)/configs/audio/audio_effects_GSI.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects_GSI.xml \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_ZE620KL.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_ZE620KL.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_ZE620KL_24bit.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_ZE620KL_24bit.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes_ZE620KL.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes_ZE620KL.xml \
...
PRODUCT_PACKAGES += \
    ...
    emmc_prop_init.sh \
    gf_fpver.sh \
    init.asus.adsp_ssr.sh \
    init.asus.gesture.sh \
    init.asus.set_time.sh \
    init.asus.sns_dump_request.sh \
