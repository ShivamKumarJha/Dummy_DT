...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_effects_ZS600KL.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects_ZS600KL.conf \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_ZS600KL.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_ZS600KL.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_ZS600KL_24bit.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_ZS600KL_24bit.xml \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_ZS600KL_EU.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_ZS600KL_EU.xml \
    ...
    $(LOCAL_PATH)/configs/audio/r_submix_audio_policy_configuration_ZS600KL_24bit.xml:$(TARGET_COPY_OUT_VENDOR)/etc/r_submix_audio_policy_configuration_ZS600KL_24bit.xml \
...
PRODUCT_PACKAGES += \
    ...
    dfps-60.sh \
    dfps-90.sh \
    dock_headset_status.sh \
    dock_spdif_status.sh \
    dp_status.sh \
    execkernelevt.sh \
    headset_status.sh \
...
# Inherit vendor
$(call inherit-product, vendor/asus/Z01QD_1/Z01QD_1-vendor.mk)