...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_tavil_ZS620KL.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_tavil_ZS620KL.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_tavil_ZS620KL_ER2.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_tavil_ZS620KL_ER2.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_tavil_ZS620KL_ER2_EU.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_tavil_ZS620KL_ER2_EU.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_tavil_ZS620KL_EU.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_tavil_ZS620KL_EU.xml \
...
# Ramdisk
PRODUCT_PACKAGES += \
    init.asus.asusinov_setproc.sh \
    init.asus.asusklog_setproc.sh \
    init.asus.asusqpst_setproc.sh \
    init.asus.check_asdf.sh \
    init.asus.check_cmdline.sh \
    init.asus.check_last.sh \
    init.asus.kernelmessage.sh \
    init.asus.kernelmessage_setproc.sh \
    init.asus.setlastshutdownproc.sh \
    init.asus.setsysfs.sh \
    init.asus.setuartlog.sh \
    init.class_main.sh \
    init.crda.sh \
    init.mdm.sh \
...
# Inherit vendor
$(call inherit-product, vendor/asus/ZS620KL/ZS620KL-vendor.mk)