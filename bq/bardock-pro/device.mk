...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_mtp_no_hifi.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_no_hifi.xml \
...
# Inherit vendor
$(call inherit-product, vendor/bq/bardock-pro/bardock-pro-vendor.mk)