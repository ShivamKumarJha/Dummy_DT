...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_platform_info_tavil_c1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_tavil_c1.xml \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_tavil_c1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_tavil_c1.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media/media_codecs_google_c2_telephony.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_c2_telephony.xml \
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.vr.headtracking.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.vr.headtracking.xml \
...
PRODUCT_PACKAGES += \
    ...
    init.crosshatch.rc \
    init.sdm845.diag.rc \
    init.sdm845.logging.rc \
    init.sdm845.mpssrfs.rc \
