...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/system/system/android.hardware.sensor.barometer.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.sensor.barometer.xml \
    ...
    frameworks/native/data/etc/system/system/android.hardware.sensor.hifi_sensors.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.sensor.hifi_sensors.xml \
    ...
    frameworks/native/data/etc/system/system/android.hardware.telephony.cdma.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.telephony.cdma.xml \
    ...
    frameworks/native/data/etc/system/system/android.hardware.vulkan.compute-0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.vulkan.compute-0.xml \
    frameworks/native/data/etc/system/system/android.hardware.vulkan.level-0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.vulkan.level-0.xml \
    frameworks/native/data/etc/system/system/android.hardware.vulkan.version-1_1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.vulkan.version-1_1.xml \
    ...
    frameworks/native/data/etc/system/system/android.software.midi.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.software.midi.xml \
