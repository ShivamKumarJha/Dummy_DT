...
panel="qdcm_calib_data_DRG_AUO_OTM1911A_FHD_video_mode_dsi_panel.xml"
qdcm_path="/data/vendor/display/qdcm_calib_data_DRG_AUO_OTM1911A_FHD_video_mode_dsi_panel.xml"
