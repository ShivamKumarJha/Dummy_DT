...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_platform_info_e2m.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_e2m.xml \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_e2m.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_e2m.xml \
...
# Inherit vendor
$(call inherit-product, vendor/nokia/Dynamo2/Dynamo2-vendor.mk)