...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/aanc_tuning_mixer_tavil.txt:$(TARGET_COPY_OUT_VENDOR)/etc/aanc_tuning_mixer_tavil.txt \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/flt.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/flt.conf \
    ...
    $(LOCAL_PATH)/configs/wifi/wpa_supplicant_diag.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wpa_supplicant_diag.conf \
