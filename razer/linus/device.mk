...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/wpa_supplicant_custom.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wpa_supplicant_custom.conf \
    $(LOCAL_PATH)/configs/wifi/wpa_supplicant_overlay.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wpa_supplicant_overlay.conf \

# Inherit vendor
$(call inherit-product, vendor/razer/linus/linus-vendor.mk)