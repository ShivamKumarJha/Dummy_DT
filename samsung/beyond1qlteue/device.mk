...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/vendor/etc/carrier/CHA/permissions/android.hardware.telephony.cdma.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/etc/carrier/CHA/permissions/android.hardware.telephony.cdma.xml \
    frameworks/native/data/etc/vendor/etc/carrier/FKR/permissions/android.hardware.telephony.cdma.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/etc/carrier/FKR/permissions/android.hardware.telephony.cdma.xml \
...
# Inherit vendor
$(call inherit-product, vendor/samsung/beyond1qlteue/beyond1qlteue-vendor.mk)