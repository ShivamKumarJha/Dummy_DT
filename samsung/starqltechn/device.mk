...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/nvram.txt_murata_r020_b2:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/nvram.txt_murata_r020_b2 \
    $(LOCAL_PATH)/configs/wifi/nvram.txt_murata_r021_b2:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/nvram.txt_murata_r021_b2 \
    $(LOCAL_PATH)/configs/wifi/nvram.txt_murata_r022_b2:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/nvram.txt_murata_r022_b2 \
    $(LOCAL_PATH)/configs/wifi/nvram.txt_murata_r031_b2:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/nvram.txt_murata_r031_b2 \
