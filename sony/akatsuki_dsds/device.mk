...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media/media_vib_vol_table:$(TARGET_COPY_OUT_VENDOR)/etc/media_vib_vol_table \
...
# Inherit vendor
$(call inherit-product, vendor/sony/akatsuki_dsds/akatsuki_dsds-vendor.mk)