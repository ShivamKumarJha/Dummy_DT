...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/system:$(TARGET_COPY_OUT_VENDOR)/etc/system \
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/system/android.hardware.wifi.passpoint.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.wifi.passpoint.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/bdwlan.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan.bin \
    $(LOCAL_PATH)/configs/wifi/fstman.ini:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/fstman.ini \
    $(LOCAL_PATH)/configs/wifi/p2p_supplicant_overlay.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/p2p_supplicant_overlay.conf \
    $(LOCAL_PATH)/configs/wifi/wifi_txpower.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wifi_txpower.conf \
