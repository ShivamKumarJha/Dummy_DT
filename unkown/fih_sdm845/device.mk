...
PRODUCT_PACKAGES += \
    atmel_tpselftest.sh \
    autoupdate_asicfw.sh \
    dump_eeprom.sh \
    fcat1.sh \
    fcat_apk_svc.sh \
    fqcaudioloopback_aop.sh \
    init.aop.lcm.sh \
    init.aop.zram.sh \
    init.class_main.sh \
    init.crda.sh \
    ...
    init.aop.asic.rc \
    init.aop.audio.rc \
    init.aop.autoupdate.rc \
    init.aop.battery.rc \
    init.aop.diagtest.rc \
    init.aop.elabel.rc \
    init.aop.fcatsvc.rc \
    init.aop.fqcrangefinder.rc \
    init.aop.lcm.rc \
    init.aop.lightcal.rc \
    init.aop.ramdump.rc \
    init.aop.runin.rc \
    init.aop.sensor.rc \
    init.aop.target.rc \
    init.aop.tlogd.rc \
    init.aop.touch.rc \
    init.aop.vibrator.rc \
    init.aop.wbg.rc \
    init.egis.fingerprint.rc \
    ...
    init.qcom.target.rc \
    init.qcom.usb.rc \
    init.sku.600E0.AOP.1.rc \
    init.sku.600E0.rc \
    init.sku.600RU.AOP.1.rc \
    init.sku.600RU.rc \
    init.sku.600WW.AOP.1.rc \
    init.sku.600WW.rc \
    init.sku.rc \
    init.target.rc \
    fstab.qcom \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/bdwlan_AOP_cal.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_AOP_cal.bin \
...
# Inherit vendor
$(call inherit-product, vendor/unkown/fih_sdm845/fih_sdm845-vendor.mk)