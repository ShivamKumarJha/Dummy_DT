...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/a2dp_audio_policy_configuration.xml.1:$(TARGET_COPY_OUT_VENDOR)/etc/a2dp_audio_policy_configuration.xml.1 \
    $(LOCAL_PATH)/configs/audio/audio_effects.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.conf \
    $(LOCAL_PATH)/configs/audio/audio_effects.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.xml \
    $(LOCAL_PATH)/configs/audio/audio_output_policy.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_output_policy.conf \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1709.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1709.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1709F_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1709F_EX.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1709LG4.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1709LG4.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1710.111111.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1710.111111.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1710.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1710.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1710F_EX.111111.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1710F_EX.111111.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1710F_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1710F_EX.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1710LG4.111111.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1710LG4.111111.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1710LG4.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1710LG4.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1721.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1721.xml \
    ...
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1730C.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1730C.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1730CF_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1730CF_EX.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1730D.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1730D.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1730DF_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1730DF_EX.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1730DLG4.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1730DLG4.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1814.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1814.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1814F_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1814F_EX.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1814LG4.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1814LG4.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1816.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1816.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.PD1816LG4.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.PD1816LG4.xml \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration.PD1814.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.PD1814.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration.xml.1:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml.1 \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes.PD1814.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes.PD1814.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes.xml.1:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes.xml.1 \
    ...
    $(LOCAL_PATH)/configs/audio/default_volume_tables.PD1814.xml:$(TARGET_COPY_OUT_VENDOR)/etc/default_volume_tables.PD1814.xml \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths.PD1730C.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.PD1730C.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths.PD1730CF_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.PD1730CF_EX.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths.PD1730D.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.PD1730D.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths.PD1730DF_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.PD1730DF_EX.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths.PD1730DLG4.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.PD1730DLG4.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths.PD1814.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.PD1814.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths.PD1814F_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.PD1814F_EX.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths.PD1814LG4.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.PD1814LG4.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths.PD1816.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.PD1816.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths.PD1816LG4.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.PD1816LG4.xml \
    ...
    $(LOCAL_PATH)/configs/audio/r_submix_audio_policy_configuration.xml.1:$(TARGET_COPY_OUT_VENDOR)/etc/r_submix_audio_policy_configuration.xml.1 \
    ...
    $(LOCAL_PATH)/configs/audio/usb_audio_policy_configuration.xml.1:$(TARGET_COPY_OUT_VENDOR)/etc/usb_audio_policy_configuration.xml.1 \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media/media_codecs_performance_sdm636.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance_sdm636.xml \
    $(LOCAL_PATH)/configs/media/media_codecs_sdm636.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_sdm636.xml \
    ...
    $(LOCAL_PATH)/configs/media/media_profiles_sdm636.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_sdm636.xml \
...
# Inherit vendor
$(call inherit-product, vendor/vivo/PD1814/PD1814-vendor.mk)