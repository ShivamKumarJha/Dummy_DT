...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/vendor/fs_overlay/d9_wifi/etc/permissions/android.hardware.location.gps.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/fs_overlay/d9_wifi/etc/permissions/android.hardware.location.gps.xml \
    frameworks/native/data/etc/vendor/fs_overlay/d9_wifi/etc/permissions/android.hardware.sensor.compass.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/fs_overlay/d9_wifi/etc/permissions/android.hardware.sensor.compass.xml \
    frameworks/native/data/etc/vendor/fs_overlay/d9_wifi/etc/permissions/android.hardware.telephony.cdma.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/fs_overlay/d9_wifi/etc/permissions/android.hardware.telephony.cdma.xml \
    frameworks/native/data/etc/vendor/fs_overlay/d9_wifi/etc/permissions/android.hardware.telephony.gsm.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/fs_overlay/d9_wifi/etc/permissions/android.hardware.telephony.gsm.xml \
    frameworks/native/data/etc/vendor/fs_overlay/d9_wifi/etc/permissions/handheld_core_hardware.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/fs_overlay/d9_wifi/etc/permissions/handheld_core_hardware.xml \
    frameworks/native/data/etc/vendor/fs_overlay/d9p/etc/permissions/android.hardware.fingerprint.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/fs_overlay/d9p/etc/permissions/android.hardware.fingerprint.xml \
    frameworks/native/data/etc/vendor/fs_overlay/d9p_wifi/etc/permissions/android.hardware.fingerprint.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/fs_overlay/d9p_wifi/etc/permissions/android.hardware.fingerprint.xml \
    frameworks/native/data/etc/vendor/fs_overlay/d9p_wifi/etc/permissions/android.hardware.location.gps.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/fs_overlay/d9p_wifi/etc/permissions/android.hardware.location.gps.xml \
    frameworks/native/data/etc/vendor/fs_overlay/d9p_wifi/etc/permissions/android.hardware.telephony.cdma.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/fs_overlay/d9p_wifi/etc/permissions/android.hardware.telephony.cdma.xml \
    frameworks/native/data/etc/vendor/fs_overlay/d9p_wifi/etc/permissions/android.hardware.telephony.gsm.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/fs_overlay/d9p_wifi/etc/permissions/android.hardware.telephony.gsm.xml \
